...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        try:
            database_name = self.data_ingestion_cofig.database_name
            collection_name=self.data_ingestion_cofig.collection_name
    ...
    def export_data_into_feature_store(self,dataframe:pd.DataFrame):
        try:
            feature_store_file_path = self.data_ingestion_cofig.feature_store_file_path
            # creating folder 
    ...
    def split_data_as_train_test(self,dataframe:pd.DataFrame):
        try:
            ...
            logging.info(
                "Perfomed train test split on the dataframe."
            ) 
